 ...
 * Version: 1.2.0.1 (22th Januray, 2009) - Added default wmode param to make flash object behind div layers. By liunan
...
infosoftglobal.FusionChartsUtil.DEFAULT_MESSAGES = {
	PBarLoadingText: "正在加载, 请稍候...",
	XMLLoadingText: "正在获取数据, 请稍候...",
	ParsingDataText: "正在解析数据, 请稍候...",
	ChartNoDataText: "读取数据中, 请稍候...",
	RenderingChartText: "绘制中, 请稍候...",
	LoadDataErrorText: "读取数据错误",
...
infosoftglobal.FusionCharts = function(swf, id, w, h, debugMode, registerWithJS, c, scaleMode, lang, detectFlashVersion, autoInstallRedirect){
	...
	if (swf.indexOf("?") > -1)
	{
		...
		var pairs = swf.substring(swf.indexOf("?") + 1).split("&");
		var p = {};
		for (var key in infosoftglobal.FusionChartsUtil.DEFAULT_MESSAGES)
			p[key] = infosoftglobal.FusionChartsUtil.DEFAULT_MESSAGES[key];
	...
	{
		for (var key in infosoftglobal.FusionChartsUtil.DEFAULT_MESSAGES)
		  str.push(key + "=" + infosoftglobal.FusionChartsUtil.DEFAULT_MESSAGES[key]);
	}
	swf += "?" + str.join("&");
